...
"gridline-color: rgb(255, 255, 127);"));
    ...
    {
        SearchForm->setWindowTitle(QApplication::translate("SearchForm", "Find Files ...", 0));
        btnStartSearch->setText(QApplication::translate("SearchForm", "Search", 0));
        btnCancel->setText(QApplication::translate("SearchForm", "Cancel", 0));
        label->setText(QApplication::translate("SearchForm", "Search for:", 0));
        label_5->setText(QApplication::translate("SearchForm", "Find text:", 0));
        txtSearchFor->setText(QString());
        txtSearchFor->setPlaceholderText(QApplication::translate("SearchForm", "*.*", 0));
        label_2->setText(QApplication::translate("SearchForm", "Search in:", 0));
        label_3->setText(QApplication::translate("SearchForm", "Search in subdirectories:", 0));
        chkCaseSensitive->setText(QApplication::translate("SearchForm", "Case sensitive", 0));
        chkShowLineNumber->setText(QApplication::translate("SearchForm", "Show line number", 0));
        chkShowOnlyFiles->setText(QApplication::translate("SearchForm", "Show only file path", 0));
        btnView->setText(QApplication::translate("SearchForm", "View", 0));
        btnEdit->setText(QApplication::translate("SearchForm", "Edit", 0));
        btnGoToFile->setText(QApplication::translate("SearchForm", "Go to file", 0));
    } // retranslateUi
